...
# inner_func - Takes in two intergers. Two nested functions should perform seperate, distinct math operations using the integers. The result of both nested functions should then be added together and printed.
...
# Lunch_lady - Takes in two strings: a student's name and their lunch preference. The fuction should print both strings. If a lunch preference is not given, "Mystery Meat" should be printed instead.
